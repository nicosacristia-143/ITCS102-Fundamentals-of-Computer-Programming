    ...
    if credit_score >= 750:
        ...
        if annual_income >= 100000:
           base_interest_rate = 4.5
            ...
            print("You are eligible for a loan with a base interest rate of 5.0%.")
        ...
        if has_collateral == True:
            ...
            print("You are eligible for a loan with a base interest rate of 7.0%.")
        elif annual_income < 40000:
            base_interest_rate = 9.5
            print("You are eligible for a loan with a base interest rate of 9.5%.")
